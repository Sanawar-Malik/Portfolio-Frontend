...
import { useAllExperiencesQuery, useDeleteExperienceMutation } from '../../services/ExperienceApi';
export const ExperDelete = ({ setDeleteModal, id }) => {

  const [deleteExper] = useDeleteExperienceMutation()
  console.log("id delete", id)
  const { data: experiences } = useAllExperiencesQuery()
  console.log("projects", experiences)

  const single = experiences ? experiences.find((ele) => ele.id === id) : null;
  return (
      ...
      <div className="relative  sm mx-auto bg-white my-10">
        <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
          <div className="flex items-start justify-between p-2 border-b bg-light-gray border-solid border-gray-300 rounded-t ">
            <h3 className="text-3xl font-semibold bg-gradient-to-r from-fuchsia-600 via-violet-600 to-indigo-600 bg-clip-text text-transparent">Delete Experience</h3>
            ...
            <div class="max-w-lg mx-auto bg-white w-96  p-5">
              ...
              <div className="flex items-end justify-end mt-12">
                ...
                <button
                  ...
                  type="button"
                  onClick={() => { setDeleteModal(false); { deleteExper(id) } }}
                >
                  Delete
                </button>
              </div>
